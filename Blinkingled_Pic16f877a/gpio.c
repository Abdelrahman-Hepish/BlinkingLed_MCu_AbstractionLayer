...
void GPIO_InitPort(tPORT port ,tPORT_DIRECTION direction ,tSTATE init_state)
{
    ...
    GPIO_SetPortData(port,init_state) ;
}
...
void GPIO_SetPortData(tPORT port,U8 data)
{
    ...
    break;
    case PORT_E :
        SetRegister(DATA_REGISTER_WRITE_PORTE,data) ;
    break;
    default :
        /* should not be here */
    break ;
...
void GPIO_SetPortDirection(tPORT port,U8 direction)
{
    ...
    break;
    case PORT_C :
        SetRegister(DIRECTION_REGISTER_PORTC,direction) ;
    break;
    case PORT_D :
        SetRegister(DIRECTION_REGISTER_PORTD,direction) ;
    break;
    case PORT_E :
        SetRegister(DIRECTION_REGISTER_PORTE,direction) ;
    break;
    default :
        /* should not be here */
    break ;
...
void GPIO_SetPinState(tPORT port , tPIN pin , tSTATE state)
{
    ...
    break;
    case PORT_E :
        SetRegisterPin(DATA_REGISTER_WRITE_PORTE,pin,state) ;
    break;
    default :
        /* should not be here */
    break ;
...
tSTATE GPIO_GetPinState(tPORT port , tPIN pin)
{
    ...
    break;
    case PORT_E :
      ret=  ReadRegisterPinValue(DATA_REGISTER_READ_PORTE,pin) ;
    break;
    default :
        /* should not be here */
    break ;
